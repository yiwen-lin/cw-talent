...
var lineChartTransformX = 60;
var lineChartTransformY = 40;
...
function initTwVacanciesLineChart() {
  var chartContainer = document.getElementById("tw_vacancies-line_chart");
  var containerClientRect = chartContainer.getBoundingClientRect();
  var windowWidth = window.innerWidth;
  ...
  function drawChart() {
    ...
    twVacancies.attr({
      ...
      viewBox: "0 0 ".concat(lineViewBoxSize.width, " ").concat(lineViewBoxSize.height)
    });
    ...
    var axisX = d3.svg.axis().scale(scaleX).orient("bottom").tickValues([0, 1, 2, 3, 4]).tickFormat(function (d) {
      return "".concat(axisXTick[d]);
    }).tickPadding(10);
    var axisY = d3.svg.axis().scale(scaleY).orient("left").tickValues([0, 200000, 400000, 600000]).tickFormat(function (d) {
    ...
    twVacancies.append("path").attr({
      ...
      "stroke-width": "2.5px",
      fill: "none",
      transform: "translate(".concat(lineChartTransformX, ", ").concat(lineChartTransformY, ")") //折線圖也要套用 translate
    ...
    twVacancies.append("g").call(axisXGrid).attr({
      fill: "none",
      stroke: "rgba(0,0,0,.1)",
      transform: "translate(".concat(lineChartTransformX, ",").concat(height + lineChartTransformY, ")")
    });
    twVacancies.append("g").call(axisYGrid).attr({
      fill: "none",
      stroke: "rgba(0,0,0,.1)",
      transform: "translate(".concat(lineChartTransformX, ",").concat(lineChartTransformY, ")")
    }); // Axis

    twVacancies.append("g").call(axisX).attr({
      fill: "none",
      transform: "translate(".concat(lineChartTransformX, ",").concat(height + lineChartTransformY, ")")
    }).selectAll("text").attr({
      fill: "#000",
    ...
    twVacancies.append("g").call(axisY).attr({
      fill: "none",
      transform: "translate(".concat(lineChartTransformX, ", ").concat(lineChartTransformY, ")")
    }).selectAll("text").attr({
      fill: "#000",
    ...
    twVacancies.append("text").attr({
      "class": "x label",
      transform: "translate(".concat(lineChartTransformX, ", ").concat(lineChartTransformY, ")"),
      x: -45,
      y: -20
    }).text("職缺數");
    twVacancies.selectAll("circle.red").data(data).enter().append("circle").attr({
      'fill': '#fff',
      'stroke': '#AE4420',
      'stroke-width': '5',
      'r': 5,
      ...
      var tooltipConfig = {
        value: "".concat(d.y.toLocaleString('en'))
      };
...
function initWorkPeopleLineChart() {
  var chartContainer = document.getElementById("work_people-line_chart");
  var containerClientRect = chartContainer.getBoundingClientRect();
  var windowWidth = window.innerWidth;
  var windowHeight = window.innerHeight;
  ...
  function drawChart() {
    ...
    var axisX = d3.svg.axis().scale(scaleX).orient("bottom").tickValues([0, 1, 2]).tickFormat(function (d) {
      return "".concat(axisXTick[d]);
    }).tickPadding(10);
    var axisY = d3.svg.axis().scale(scaleY).orient("left").tickValues([1500, 1550, 1600, 1650, 1700, 1750]).tickFormat(function (d) {
      return d + "萬";
    });
    ...
    workPeople.append("g").call(axisXGrid).attr({
      fill: "none",
      stroke: "rgba(0,0,0,.1)",
      transform: "translate(".concat(lineChartTransformX, ",").concat(height + lineChartTransformY, ")")
    });
    ...
    workPeople.append("g").call(axisX).attr({
      fill: "none",
      transform: "translate(".concat(lineChartTransformX, ",").concat(height + lineChartTransformY, ")")
    }).selectAll("text").attr({
      fill: "#000",
    ...
    workPeople.append("g").call(axisY).attr({
      fill: "none",
      transform: "translate(".concat(lineChartTransformX, ", ").concat(lineChartTransformY, ")")
    }).selectAll("text").attr({
      fill: "#000",
    ...
    workPeople.append("text").attr({
      "class": "x label",
      transform: "translate(".concat(lineChartTransformX, ", ").concat(lineChartTransformY, ")"),
      x: -45,
      y: -20
    }).text("人數");
    workPeople.selectAll("circle.red").data(data).enter().append("circle").attr({
      'fill': '#fff',
      'stroke': '#AE4420',
      'stroke-width': '5',
      'r': 5,
...
var barChartTransformX = 60;
var barChartTransformY = 20;
var xLebelSize = "14px";
var barViewBoxSize = {};
...
function initSkillWhenBarChart() {
  var chartContainer = document.getElementById("skill_when-bar_chart");
  var containerClientRect = chartContainer.getBoundingClientRect();
  var windowWidth = window.innerWidth;
  var windowHeight = window.innerHeight;
  ...
  function drawChart() {
    var skillWhen = d3.select("#skill_when-bar_chart");
    skillWhen.html("");
    var parent = skillWhen.select(function () {
      return this.parentNode;
    });
    var parentWidth = parseInt(parent.style("width"));
    var width = windowWidth <= 575 ? 0.88 * parentWidth : 0.74 * parentWidth;

    var _height = windowWidth <= 575 ? 0.57 * parentWidth : 0.53 * parentWidth;
    ...
    skillWhen.attr({
      ...
      viewBox: "0 0 ".concat(barViewBoxSize.width, " ").concat(barViewBoxSize.height)
    }); // Scales

    var scaleX = d3.scale.ordinal().domain(data.map(function (data) {
      return data.x;
    })).rangeRoundBands([0, width]);
    var scaleY = d3.scale.linear().domain([0, d3.max(data, function (d) {
      return d.y;
    }) * 1.1]).range([_height, 0]); // axis

    var axisX = d3.svg.axis().scale(scaleX).orient("bottom").tickFormat(function (d) {
      return "".concat(d);
    }).tickPadding(10);
    skillWhen.append("g").call(axisX).attr({
      fill: "none",
      "class": "x axis",
      transform: "translate(".concat(barChartTransformX, ", ").concat(_height + barChartTransformY, ")")
    }).selectAll("text").attr({
      fill: "#000",
      stroke: "none"
    }).style({
    ...
    var axisY = d3.svg.axis().scale(scaleY).orient("left").tickValues([0, 10, 20, 30, 40]);
    skillWhen.append("g").call(axisY).attr({
      fill: "none",
      "class": "y axis",
      transform: "translate(".concat(barChartTransformX, ", ").concat(barChartTransformY, ")")
    }).selectAll("text").attr({
      fill: "#000",
      stroke: "none"
    }).style({
    ...
    var bar = skillWhen.selectAll(".bar").data(data).enter().append("rect").attr({
      fill: "#AE441F",
      "class": "bar",
      y: _height,
      height: 0,
      transform: "translate(".concat(barChartTransformX + scaleX.rangeBand() / 4, ", ").concat(barChartTransformY, ")")
    }).attr("x", function (d) {
      return scaleX(d.x);
    }).attr("width", scaleX.rangeBand() / 2).transition().duration(1500).attr({
      y: function y(d) {
        return scaleY(d.y);
      },
      height: function height(d) {
        return _height - scaleY(d.y);
      }
    }); // bar.transition()
    //   .duration(1500)
    //   .ease("elastic")
    ...
    skillWhen.selectAll("text.bar_data").data(data).enter().append("text").text(function (d) {
      return d.y;
    }).attr({
      width: "20",
      fill: "#AE441F",
...
function initSkillIn3YearsBarChart() {
  var chartContainer = document.getElementById("skill_in_3years-bar_chart");
  var containerClientRect = chartContainer.getBoundingClientRect();
  var windowWidth = window.innerWidth;
  var windowHeight = window.innerHeight;
  ...
  function drawChart() {
    var skillIn3Years = d3.select("#skill_in_3years-bar_chart");
    skillIn3Years.html("");
    var parent = skillIn3Years.select(function () {
      return this.parentNode;
    });
    var parentWidth = parseInt(parent.style("width"));
    var width = windowWidth <= 575 ? 0.88 * parentWidth : 0.74 * parentWidth;

    var _height2 = windowWidth <= 575 ? 0.57 * parentWidth : 0.53 * parentWidth;
    ...
    var scaleY = d3.scale.linear().domain([0, d3.max(data, function (d) {
      return d.y;
    }) * 1.1]).range([_height2, 0]); // axis

    var axisX = d3.svg.axis().scale(scaleX).orient("bottom").tickFormat(function (d) {
      return "".concat(d);
    }).tickPadding(10);
    skillIn3Years.append("g").call(axisX).attr({
      fill: "none",
      "class": "x axis",
      transform: "translate(".concat(barChartTransformX, ", ").concat(_height2 + barChartTransformY, ")")
    }).selectAll("text").attr({
      fill: "#000",
      stroke: "none"
    }).style({
    ...
    var axisY = d3.svg.axis().scale(scaleY).orient("left").tickValues([0, 10, 20, 30, 40]);
    skillIn3Years.append("g").call(axisY).attr({
      fill: "none",
      "class": "y axis",
      transform: "translate(".concat(barChartTransformX, ", ").concat(barChartTransformY, ")")
    }).selectAll("text").attr({
    ...
    var bar = skillIn3Years.selectAll(".bar").data(data).enter().append("rect").attr({
      fill: "#AE441F",
      "class": "bar",
      y: _height2,
      height: 0,
    ...
    skillIn3Years.append("text").attr({
      "class": "x label",
      transform: "translate(".concat(lineChartTransformX, ", ").concat(lineChartTransformY, ")"),
      x: barChartTransformX - 82,
      y: -10
    ...
    skillIn3Years.selectAll("text.bar_data").data(data).enter().append("text").text(function (d) {
      return d.y;
    }).attr({
      width: "20",
      fill: "#AE441F",
...
var arcChartTransformX = 200;
var arcChartTransformY = 140;
var arcViewBoxSize = {};
...
function initSelfArcChart() {
  var chartContainer = document.getElementById("self-arc_chart");
  var containerClientRect = chartContainer.getBoundingClientRect();
  var windowWidth = window.innerWidth;
  var windowHeight = window.innerHeight;
  ...
  function drawChart() {
    var arcChart = d3.select("#self-arc_chart");
    arcChart.html("");
    var parent = arcChart.select(function () {
      return this.parentNode;
    });
    var parentWidth = parseInt(parent.style("width"));
    var transitionUnit = 3500;
    arcChart.attr({
      width: parentWidth,
      height: 0.76 * parentWidth,
      viewBox: "0 0 ".concat(arcViewBoxSize.width, " ").concat(arcViewBoxSize.height)
    });
    var dataArc1 = [{
      startAngle: 0,
      endAngle: 360 * 0.54 * (Math.PI / 180)
    }];
    var arc1 = d3.svg.arc().innerRadius(50).outerRadius(90);
    arcChart.append("path").data(dataArc1).attr({
      d: arc1,
      transform: "translate(".concat(arcChartTransformX, ",").concat(arcChartTransformY, ")"),
      fill: "#AE441F"
    }).transition().duration(0.54 * transitionUnit).attrTween("d", function (d) {
      var start = {
        startAngle: 0,
        endAngle: 0
      }; // <-A
    ...
    arcChart.append("rect").attr({
      ...
      height: 1,
      fill: "#000",
      transform: "translate(".concat(arcChartTransformX - 50, ",").concat(arcChartTransformY, ")")
    }).transition().duration(1000).delay(0.54 * transitionUnit + 300).attr({
      x: 0,
      width: 60
    });
    var arc1_label = arcChart.append("text").attr({
      x: 0,
      y: -80,
      transform: "translate(".concat(arcChartTransformX - 80, ",").concat(arcChartTransformY, ")")
    }).style({
      opacity: 0
    }).text("");
    arc1_label.append("tspan").attr({
      x: 0,
      dy: 0,
      "text-anchor": "middle"
    }).style({
    ...
    arc1_label.transition().duration(500).delay(0.54 * transitionUnit + 1300).style({
      opacity: 1
    });
    var dataArc2 = [{
      startAngle: 0,
    ...
    var arc2 = d3.svg.arc().innerRadius(90).outerRadius(130);
    arcChart.append("path").data(dataArc2).attr({
      d: arc2,
      transform: "translate(".concat(arcChartTransformX, ",").concat(arcChartTransformY, ")"),
      fill: "#F3E8D3"
    }).transition().duration(0.66 * transitionUnit).attrTween("d", function (d) {
      var start = {
        startAngle: 0,
        endAngle: 0
      }; // <-A
    ...
    arcChart.append("rect").attr({
      ...
      fill: "#000",
      transform: "translate(".concat(arcChartTransformX, ",").concat(arcChartTransformY, ")")
    }).transition().duration(1000).delay(0.66 * transitionUnit + 300).attr({
      width: 60
    });
    var arc2_label = arcChart.append("text").attr({
      x: 0,
      y: 80,
      transform: "translate(".concat(arcChartTransformX + 165, ",").concat(arcChartTransformY, ")")
    }).style({
      opacity: 0
    }).text("");
    arc2_label.append("tspan").attr({
      x: 0,
      dy: 0,
      "text-anchor": "middle"
    }).style({
    ...
    arc2_label.transition().duration(500).delay(0.54 * transitionUnit + 1300).style({
      opacity: 1
    });
  }
}
...
function initWfhArcChart() {
  var chartContainer = document.getElementById("wfh-arc_chart");
  var containerClientRect = chartContainer.getBoundingClientRect();
  var windowWidth = window.innerWidth;
  var windowHeight = window.innerHeight;
  ...
  function drawChart() {
    var arcChart = d3.select("#wfh-arc_chart");
    arcChart.html("");
    var parent = arcChart.select(function () {
      return this.parentNode;
    });
    ...
    arcChart.append("path").data(dataArc1).attr({
      ...
      transform: "translate(".concat(arcChartTransformX, ",").concat(arcChartTransformY, ")"),
      fill: "#AE441F"
    }).transition().duration(0.68 * transitionUnit).attrTween("d", function (d) {
      var start = {
        startAngle: 0,
        endAngle: 0
      }; // <-A
    ...
    arcChart.append("rect").attr({
      ...
      fill: "#000",
      transform: "translate(".concat(arcChartTransformX - 50, ",").concat(arcChartTransformY, ")")
    }).transition().duration(1000).delay(0.68 * transitionUnit + 300).attr({
      x: 0,
      width: 60
    });
    var arc1_label = arcChart.append("text").attr({
    ...
    arc1_label.transition().duration(500).delay(0.68 * transitionUnit + 1300).style({
      opacity: 1
    });
    var dataArc2 = [{
      startAngle: 0,
      endAngle: 360 * 0.63 * (Math.PI / 180)
    }];
    var arc2 = d3.svg.arc().innerRadius(90).outerRadius(130);
    arcChart.append("path").data(dataArc2).attr({
      d: arc2,
      transform: "translate(".concat(arcChartTransformX, ",").concat(arcChartTransformY, ")"),
      fill: "#F3E8D3"
    }).transition().duration(0.63 * transitionUnit).attrTween("d", function (d) {
      var start = {
        startAngle: 0,
        endAngle: 0
      }; // <-A
    ...
    arcChart.append("rect").attr({
      ...
      fill: "#000",
      transform: "translate(".concat(arcChartTransformX, ",").concat(arcChartTransformY, ")")
    }).transition().duration(1000).delay(0.63 * transitionUnit + 300).attr({
      width: 60
    });
    var arc2_label = arcChart.append("text").attr({
      x: 0,
    ...
    arc2_label.transition().duration(500).delay(0.68 * transitionUnit + 1300).style({
      opacity: 1
    });
  }
}
...
function initD3Number(target) {
  function floatCount(target) {
    var x = String(target).indexOf(".") + 1;
    return String(target).length - x;
  }

  var selector = d3.selectAll(target);
  selector.each(function () {
    var number_selector = d3.select(this);
    var number = [Number(number_selector.attr("data-number"))];
    var digits = floatCount(number[0]);
    number_selector.selectAll("text").data(number).enter().append("text").text(function (d) {
      return d;
    }).transition().duration(3000).tween("number", function (d) {
...
function initChart1Number() {
  var chartContainer = document.getElementById("chart1-1");
  var containerClientRect = chartContainer.getBoundingClientRect();
  var windowHeight = window.innerHeight;
...
function initChart2Number() {
  var chartContainer = document.getElementById("chart2-2");
  var containerClientRect = chartContainer.getBoundingClientRect();
  var windowHeight = window.innerHeight;
...
function onMapChartActive() {
  var mapChart = document.getElementById('map-chart');
  var mapChartClientRect = mapChart.getBoundingClientRect();
  var windowHeight = window.innerHeight; // 小於一半 viewport
...
function onLowBirthLineChartActive() {
  var lowBirthLineChart = d3.select('#low-birth-line-chart');
  var lowBirthLineChartBlock = document.getElementById('low-birth-line-chart');
  var lineChartClientRect = lowBirthLineChartBlock.getBoundingClientRect();
  var windowHeight = window.innerHeight;
  var windowWidth = window.innerWidth;
  ...
  function drawChart() {
    var isLargeScreen = window.innerWidth >= 1400;
    var isSmallScreen = window.innerWidth < 600;
    var parent = lowBirthLineChart.select(function () {
      return this.parentNode;
    });
    var parentWidth = parseInt(parent.style('width'));
    var width = parentWidth * 0.79;
    var height = window.innerWidth * 0.31;
    ...
    var scaleX = d3.scale.linear().range([0, width]).domain([0, 7]);
    var scaleY = d3.scale.linear().range([height, 0]).domain([0, 2000]);
    var line = d3.svg.line().x(function (d) {
      return scaleX(d.x);
    }).y(function (d) {
      return scaleY(d.y);
    });
    var axisX = d3.svg.axis().scale(scaleX).orient('bottom').tickValues([0, 1, 2, 3, 4, 5, 6, 7]).tickFormat(function (d) {
      return "20".concat(d, "0");
    }).ticks(7).tickPadding(width / 14 * 0.3);
    var axisY = d3.svg.axis().scale(scaleY).orient('left').ticks(4).tickFormat(function (d) {
      return d ? d + ' 萬' : d;
    }).tickPadding(width / 14 * 0.3);
    var axisXGrid = d3.svg.axis().scale(scaleX).orient('bottom').ticks(7).tickFormat('').tickSize(-height, 0);
    var axisYGrid = d3.svg.axis().scale(scaleY).orient('left').ticks(5).tickFormat('').tickSize(-width, 0); // Axis Grid line

    lowBirthLineChart.append('rect').attr({
      width: width,
      height: height,
      fill: '#fff',
    ...
    lowBirthLineChart.append('rect').attr({
      ...
      'height': height,
      'fill': '#FFFCD7',
      'transform': "translate(".concat(width / 14 * 5 + translateX, ", ").concat(translateY, ")"),
      'style': 'opacity: 0;'
    }).transition().duration(1000).delay(5000).style({
      'opacity': 1
    }); // 黃色區塊左邊線
    ...
    lowBirthLineChart.append('text').attr({
      ...
      'opacity': 0
    }).text(isSmallScreen ? '2025年：老年人口>20%' : '2025年').transition().duration(1000).delay(5000).style({
      'opacity': 1
    });
    lowBirthLineChart.append('text').attr({
      ...
      'font-size': isLargeScreen ? '18px' : '12px',
      'opacity': 0
    }).text(isSmallScreen ? '台灣將正式進入超高齡化社會' : '老年人口>20%，台灣將正式進入超高齡化社會').transition().duration(1000).delay(5000).style({
      'opacity': 1
    }); // 折線段

    lowBirthLineChart.append('path').attr({
    ...
    lowBirthLineChart.append('rect').attr({
      ...
      'fill': '#999',
      'transform': "translate(".concat(translateX, ", ").concat(translateY, ")")
    }).transition().duration(1000).delay(3000).attr({
      'y': height / 36,
      'height': height / 8 * 1
    });
    lowBirthLineChart.append('text').attr({
      ...
      'font-size': isLargeScreen ? '18px' : '12px',
      'opacity': 0
    }).text(isSmallScreen ? '勞動人口一路下滑' : '2015年').transition().duration(1000).delay(3000).style({
      'opacity': 1
    });
    lowBirthLineChart.append('text').attr({
      ...
      'font-size': isLargeScreen ? '18px' : '12px',
      'opacity': 0
    }).text(isSmallScreen ? '' : '勞動人口(15-64歲)一路下滑').transition().duration(1000).delay(3000).style({
      'opacity': 1
    }); // 2017年文字
    ...
    lowBirthLineChart.append('rect').attr({
      ...
      'fill': '#999',
      'transform': "translate(".concat(translateX, ", ").concat(translateY, ")")
    }).transition().duration(1000).delay(4000).attr({
      'y': height / 16 * 11.4,
      'height': height / 8 * 1
    });
    lowBirthLineChart.append('text').attr({
      ...
      'font-size': isLargeScreen ? '18px' : '12px',
      'opacity': 0
    }).text(isSmallScreen ? '老年人口超越' : '2017年').transition().duration(1000).delay(4000).style({
      'opacity': 1
    });
    lowBirthLineChart.append('text').attr({
      ...
      'font-size': isLargeScreen ? '18px' : '12px',
      'opacity': 0
    }).text(isSmallScreen ? '幼年人口' : '老年人口超越幼年人口').transition().duration(1000).delay(4000).style({
      'opacity': 1
    }); // 動畫遮線條用白色區塊
    ...
    lowBirthLineChart.append('rect').attr({
      ...
      'transform': "translate(".concat(width + translateX, ", ").concat(translateY, ")")
    }).style({
      'width': '0'
    });
    lowBirthLineChart.append('g').call(axisXGrid).attr({
      'fill': 'none',
      'stroke': 'rgba(0, 0, 0, 0.1)',
      'transform': "translate(".concat(translateX, ", ").concat(height + translateY, ")")
    });
    lowBirthLineChart.append('g').call(axisYGrid).attr({
      'fill': 'none',
      'stroke': 'rgba(0, 0, 0, 0.1)',
      'transform': "translate(".concat(translateX, ", ").concat(translateY, ")")
    }); // Axis 

    lowBirthLineChart.append('g').call(axisX).attr({
      'fill': 'none',
      'transform': "translate(".concat(translateX, ", ").concat(height + translateY, ")")
    }).selectAll('text').attr({
      'fill': '#000',
    ...
    lowBirthLineChart.append('g').call(axisY).attr({
      'fill': 'none',
      'transform': "translate(".concat(translateX, ", ").concat(translateY, ")")
    }).selectAll('text').attr({
      'fill': '#000',
    ...
    lowBirthLineChart.append('text').attr({
      ...
      'font-size': isLargeScreen ? '18px' : '12px',
      'opacity': 0
    }).text('15~64歲').transition().duration(1000).delay(2500).style({
      'opacity': 1
    });
    lowBirthLineChart.append('text').attr({
      ...
      'font-size': isLargeScreen ? '18px' : '12px',
      'opacity': 0
    }).text('65歲以上').transition().duration(1000).delay(2500).style({
      'opacity': 1
    });
    lowBirthLineChart.append('text').attr({
      ...
      'font-size': isLargeScreen ? '18px' : '12px',
      'opacity': 0
    }).text('0~14歲').transition().duration(1000).delay(2500).style({
      'opacity': 1
    });
    lowBirthLineChart.append('text').attr({
    ...
    if (!isSmallScreen) {
      lowBirthLineChart.selectAll('circle.gray').data(lowBirthRate014Data).enter().append('circle').attr({
        'fill': '#fff',
        'stroke': '#999',
        'stroke-width': '5',
        'r': 5,
      ...
      lowBirthLineChart.selectAll('circle.red').data(lowBirthRate1564Data).enter().append('circle').attr({
        'fill': '#fff',
        'stroke': '#AE4420',
        'stroke-width': '5',
        'r': 5,
      ...
      lowBirthLineChart.selectAll('circle.brown').data(lowBirthRate65UpData).enter().append('circle').attr({
        'fill': '#fff',
        'stroke': '#C7B299',
        'stroke-width': '5',
        'r': 5,
...
function onCountriesBarChartActive() {
  var countriesBarChart = d3.select('#countries-bar-chart');
  var countriesBarChartBlock = document.getElementById('countries-bar-chart');
  var barChartClientRect = countriesBarChartBlock.getBoundingClientRect();
  var windowHeight = window.innerHeight;
  var windowWidth = window.innerWidth;
  ...
  function drawChart() {
    ...
    countriesBarChart.append('svg').attr({
    ...
    }).selectAll('rect').data(mapChartData).enter().append('g').append('rect').attr({
      'fill': '#FFDD4D',
      'width': 0,
      'height': 8,
      'x': 0,
      ...
      'width': function width(d) {
        return "".concat(d.value * 0.8, "%");
      }
    }).attrTween('fill', function (d) {
      var fillColor = '#FFDD4D';
    ...
    countriesBarChart.select('svg').append('path').attr({
      'd': "M0 ".concat(20 * 30 + 20, " H").concat(window.innerWidth),
      'stroke': '#777',
      'stroke-width': '1px',
      'stroke-dasharray': '2',
      'fill': 'none'
    });
    countriesBarChart.select('svg').append('text').attr({
    ...
    countriesBarChart.select('.text-average').append('tspan').attr({
      'x': window.innerWidth - 45,
      'dy': 16
    }).text('球');
    countriesBarChart.select('.text-average').append('tspan').attr({
    ...
    countriesBarChart.selectAll('g').append('text').attr({
      'fill': '#000',
      'x': 10,
      'y': function y(d) {
        return d.x * 30 + 11;
      ...
      'x': function x(d) {
        return "".concat(d.value * 0.8 + 10, "%");
      }
    }).tween('number', function (d) {
      var i = d3.interpolateRound(0, d.value);
      return function (t) {
        this.textContent = "".concat(d.name, " ").concat(i(t), "%");
      };
    });
    countriesBarChart.selectAll('div').data(mapChartData).enter().append('div').attr({
      'class': 'flag'
    }).style({
      'left': 0,
      'top': function top(d) {
        return "".concat(d.x * 30 - 2, "px");
      },
      'background-position-x': function backgroundPositionX(d) {
        return "".concat(100 / 39 * d.x, "%");
      }
    }).transition().duration(3000).style({
      'left': function left(d) {
        return "".concat(d.value * 0.8 + 1.5, "%");
      }
    });
  }
}
...
function showChartToolTip(config) {
  var chartTooltip = d3.select('#chart-tooltip');
  ...
  chartTooltip.attr({
    ...
    'left': "".concat(mousePos.x - 30, "px"),
    'top': "".concat(mousePos.y - (color && title ? 70 : 45), "px")
  });

  if (color && title) {
    chartTooltip.append('section').append('div').attr({
      'class': 'tooltip-color'
    }).style({
      'background': color
    });
    chartTooltip.select('section').append('p').attr({
      'class': 'tooltip-title'
    }).text(title);
  }

  chartTooltip.append('p').attr({
    'class': 'tooltip-value'
  }).text(value);
}
/** 隱藏圖表 Tooltip */
